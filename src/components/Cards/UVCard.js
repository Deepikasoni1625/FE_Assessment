      ...
      <div style={styles.body}>
        ...
        <div style={styles.textWrapper}>
          <div style={styles.smallTextWrapper}>
            <text style={styles.smallText}>0-2</text>
            <BorderLinearProgress variant="determinate" value={100} />
          </div>
          <div style={styles.smallTextWrapper}>
            <text style={styles.smallText}>3-5</text>
            <BorderLinearProgress variant="determinate" value={50} />
          </div>
          <div style={styles.smallTextWrapper}>
            <text style={styles.smallText}>6-7</text>
            <BorderLinearProgress variant="determinate" value={0} />
          </div>
          <div style={styles.smallTextWrapper}>
            <text style={styles.smallText}>8-10</text>
            <BorderLinearProgress variant="determinate" value={0} />
          </div>
          <div style={styles.smallTextWrapper}>
            <text style={styles.smallText}>11+</text>
            <BorderLinearProgress variant="determinate" value={0} />
          </div>
        </div>
      </div>
